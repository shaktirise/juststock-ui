                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            const Text("0.029 ETH",style: TextStyle(fontSize: 11,color: Color(0xFF8B0000),fontFamily: "Manrope-SemiBold"),),
                                            const Spacer(),
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            const Text("0.500 ETH",style: TextStyle(fontSize: 11,color: Color(0xFF8B0000),fontFamily: "Manrope-SemiBold"),),
                                            const Spacer(),

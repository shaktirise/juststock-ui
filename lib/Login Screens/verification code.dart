          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child:const Center(child: Text("Resend Code",style: TextStyle(fontSize: 16,color: Color(0xFF8B0000),fontFamily: "Manrope-Bold"))) ,
              ),
            ),
            // Container(
            //   height: 56,
            ...
            //   child: Center(
            //       child: Text("",
            //           style: TextStyle(fontSize: 16, color: Color(0xFF8B0000),fontFamily: "Manrope-Bold"))),
            // )
          ],
        ),
      ),
